...
@Component({
  ...
  template: `
    <p>
      OVERVIEW<br />
      This website is operated by Evansgray. Throughout the site, the terms “I”,
      “we”, “us”, and “our” refer to Evansgray. Evansgray offers this website,
      ...
      policies and notices stated here. For further information, please see
      Privacy Policy and Shipping and Returns. By visiting our site and/ or
      ...
      this site. You may not use our products for any illegal or unauthorized
      ...
      are subject to return or exchange only according to our Shipping and
      Returns Policy. We have made every effort to display as accurately as
      ...
      be accurate. Due to the handmade, small batch processes for Evansgray
      products, colors may show slight marbling. Natural dyes used by Evansgray
      may alter or fade over time, especially with prolonged exposure to direct
      sunlight. We reserve the right, but are not obligated, to limit the sales
      ...
      durability, title, and non-infringement. In no case shall Evansgray, our
      ...
      You agree to indemnify, defend and hold harmless Evansgray and our parent,
      ...
      NORTH KANSAS CITY, CLAY COUNTY, MO, 64116, United States.
      <br /><br />
